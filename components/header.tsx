...
export function Header() {
  const [notifications, setNotifications] = useState([
    { id: 1, message: "Agent feedback available on Office Building project", time: "Just now" },
    { id: 2, message: "Budget analysis complete for Residential Complex", time: "2 hours ago" },
  ])
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" className="gap-2">
              <div className="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center text-primary">JD</div>
